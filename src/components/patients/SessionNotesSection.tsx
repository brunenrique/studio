    ...
    <Card className="shadow-lg rounded-lg">
      <CardHeader>
        <div className="flex justify-between items-center">
          ...
          {!showAddNoteForm && (
            <Button onClick={() => setShowAddNoteForm(true)} size="sm" className="shadow-md">
      ...
      <CardContent>
        {showAddNoteForm && (
          <div className="mb-6 p-4 border rounded-md bg-card shadow">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" onClick={() => setShowAddNoteForm(false)} disabled={isSaving}>
                Cancelar
              </Button>
        ...
        {patient.sessionNotes.length === 0 && !showAddNoteForm && (
          <p className="text-muted-foreground">Nenhuma nota de sessão registrada para este paciente.</p>
        )}
