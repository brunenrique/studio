    ...
    <>
      ...
      <main id="main" className="flex min-h-screen items-center justify-center p-4 bg-background">
        <form className="space-y-4 max-w-md w-full bg-card p-6 rounded-md shadow">
          <h1 className="text-2xl font-headline text-primary">Cadastro</h1>
          <div>
          ...
          <button type="submit" className="w-full py-2 px-4 bg-primary text-primary-foreground rounded">Criar conta</button>
        </form>
      </main>
    </>
  );
